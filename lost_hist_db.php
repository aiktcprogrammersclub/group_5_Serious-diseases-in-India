...
<h3><center>Lost History</center></h3>
...
echo "<tr><br><th><font color=black>Serial No</th>
	...
	<th><font color=black>Lost Location</th>
	<th><font color=black>Lost Description</th>
	<th><font color=black>Other details</th>  
	<th><font color=black>Status</th>
	</tr>";
echo "<br>";

$sql="select * from lugg_lost";
$query=mysql_query($sql);
echo mysql_error();
while($row=mysql_fetch_array($query)){
echo "<tr> <td><font color=red>$row[sr_no]</font></td> <td><font color=red>$row[tagcode]</font></td> <td><font color=red>$row[lost_loc]</td><td><font color=red>$row[lugg_desc]</td><td><font color=red>$row[other_details]</td><td><font color=red>$row[status]</td></font></tr> <br>";
}
